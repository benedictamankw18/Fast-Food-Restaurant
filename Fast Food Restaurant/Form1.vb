...
Public Class Form1
    ...
    Sub Load_controls()
        ...
        price.Text = " Price              : GHC " & dr.Item("price").ToString
    ...
    Sub Get_grandTotal()
        Try
            ...
            Next
            lbl_GrandTotal.Text = "GHC " & Format(CDec(grandtotal), "#,##0.00")
            lbl_overallTotal.Text = "GHC " & Format(CDec(grandtotal), "#,##0.00")
            'lbl_overallTotal.Text = lbl_GrandTotal.Text
    ...
    Private Sub btn_Pay_Click(sender As Object, e As EventArgs) Handles btn_Pay.Click
        ...
        If MsgBox("Are You Sure Order Conform ?", vbQuestion + vbYesNo) = vbYes Then
            ...
            ElseIf txt_BalanceAmount.Text < 0 Then
                MsgBox("Infinity Balance !" & vbNewLine & txt_receivedAmount.Text & " GHC", MsgBoxStyle.Exclamation)
                Return
            Else
                Try
                    conn.Open()
